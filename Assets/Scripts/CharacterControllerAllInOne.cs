...
public class CharacterControllerAllInOne : MonoBehaviour
{
    [Header("Restrictions")]
    ...
    void Start()
    {
        ...
        if (!wintext)
        {
            wintext = GameObject.Find("Home Title");
        }
    ...
    void Update()
    {
        onGround = Physics2D.Raycast(transform.position + new Vector3(-0.43f, 0, 0), Vector2.down, groundLength, groundLayer) || Physics2D.Raycast(transform.position + new Vector3(0.43f, 0, 0), Vector2.down, groundLength, groundLayer);
    ...
    void OnTriggerEnter2D(Collider2D coll)
    {
        if(coll.tag == "endzone")
        {
            ...
            wintext.transform.position = new Vector3(0, -17.1f, 1);
            wintext.GetComponent<TitleTransitionHandler>().setState(TitleTransitionHandler.titleStates.enter);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(transform.position + new Vector3(0.43f, 0, 0), transform.position + new Vector3(0.43f, 0, 0) + Vector3.down * groundLength);
        Gizmos.DrawLine(transform.position + new Vector3(-0.43f, 0, 0), transform.position + new Vector3(-0.43f, 0, 0) + Vector3.down * groundLength);
